    ...
    if (loading) {
        return (
            <main className='loading-screen'>
                <h1>Generating your interview plan... (~30s)</h1>
            </main>
        )
    }
                        ...
                        <div className='upload-section'>
                            ...
                            <label className={`dropzone ${selectedFileName ? 'dropzone--selected' : ''}`} htmlFor='resume'>
                                <span className='dropzone__icon'>
                                    {selectedFileName ? (
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#3fb950" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                                    ) : (
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 16 12 12 8 16" /><line x1="12" y1="12" x2="12" y2="21" /><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3" /></svg>
                                    )}
                                </span>
                                {selectedFileName ? (
                                    <p className='dropzone__title dropzone__title--selected'>{selectedFileName}</p>
                                ) : (
                                    <>
